...
public class PetShopTest {
	...
	public void testeRecepcao() {
		try {
			...
			assertEquals(900.0, recepcao.getLucroTotal(), 0.05);
			...
			assertEquals("Estadias:\nPaola Bracho (Cobra): 1 dia(s) com o preco de R$ 10.00", recepcao.toString());
		} catch (Exception e) {
			fail(); // Nao deve lancar excecao
		}
	}
	...
	public void testeHotel() {
		try {
			...
			assertEquals("Estadias:\nJerry (Rato): 3 dia(s) com o preco de R$ 120.00", hotel.toString());
		} catch (Exception e) {
			fail(); // Nao deve lancar excecao
		}
	}
